...
import com.example.clashofclans.Model.Building.TownHall;
...
public class ThreadTownHall implements Runnable{
    ...
    public ThreadTownHall(ImageView imageView){
        townhall = new TownHall(imageView) ;
        War.buildings.add(townhall);
        War.map.put(townhall , imageView) ;
...
//                wait();
        ...
        War.buildings.remove(War.buildings.indexOf(townhall));
        War.map.get(townhall).setVisible(false);
        War.map.remove(townhall) ;
    }
